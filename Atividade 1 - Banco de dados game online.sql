...
#popoluando a tabela personagem
...
SELECT * FROM db_generation_game_online.tb_personagem WHERE poderForca > 2000; # select de poder forca  maior que 2000

SELECT * FROM db_generation_game_online.tb_personagem WHERE poderDefesa <= 2000 AND poderDefesa >= 1000; #select de pode defesa entre 1000 e 2000

SELECT * FROM db_generation_game_online.tb_personagem WHERE nome LIKE "%C%"; #select palvra com a letra C no nome


#Inner join para interacao de tabelas
